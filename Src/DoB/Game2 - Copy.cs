...
namespace GameManager
{
  public class Game2 : Game
  {
    ...
    public static Game2.GamePhase gamePhase;
    public static Game2.GameState gameState;
    ...
    public Game2()
    {
        ...
        protected override void Initialize()
        {
            ...
            Game2.gamePhase = Game2.GamePhase.HeadphonesRecommended;
            ...
            this.mapList.Add(new Map(Game2.Room.GirlBedroom, 445, "MapImages/girlbedroom4", 50, 713));

            this.mapList[0].doorList.Add((GameObject)new Door(
                Game2.Room.GirlBedroom, new Rectangle(185, 200, 88, 186), 1, 2));

            this.mapList[0].hidingSpotList.Add((GameObject)new HidingSpot(
                Game2.Room.GirlBedroom, new Rectangle(350, 330, 40, 72), "Inside Box", 100));

            this.mapList[0].hidingSpotList.Add((GameObject)new HidingSpot(
                Game2.Room.GirlBedroom, new Rectangle(670, 385, 50, 100), "Under the Bed", 100));

            this.mapList[0].itemList.Add((GameObject)new Item(
                Game2.Room.GirlBedroom, "Artifact", new Vector2(260f, 300f), 0.2f, "Art/artifact"));

            this.mapList.Add(
                new Map(Game2.Room.Corridor, 465, "MapImages/corridor", 50, 1130));

            this.mapList[1].doorList.Add(
                (GameObject)new Door(Game2.Room.Corridor, new Rectangle(770, 298, 95, 147), 2, 1));

            this.mapList[1].doorList.Add(
                (GameObject)new Door(Game2.Room.Corridor, new Rectangle(100, 200, 140, 260), 3, 4));

            this.mapList.Add(new Map(Game2.Room.ParentsRoom, 360, "MapImages/parentsroom", 80, 630));

            this.mapList[2].doorList.Add(
                (GameObject)new Door(Game2.Room.ParentsRoom, new Rectangle(250, 100, 90, 180), 4, 3));
    ...
    protected override void Update(GameTime gameTime)
    {
      ...
      if (Game2.gameState != Game2.GameState.Paused)
      {
        if (Game2.gamePhase == Game2.GamePhase.Game)
        {
      ...
      foreach (Map map in this.mapList)
      {
        foreach (Door door in map.doorList)
        {
          if ( Player.location == door.location
                ...
                && Game2.gameState != Game2.GameState.ChangingRoom )
          {
        ...
        foreach (HidingSpot hidingSpot in map.hidingSpotList)
        {
          if (Player.location == hidingSpot.location 
                        ...
                        && Game2.gameState == Game2.GameState.Active)
          {
      ...
      (
        ...
        && Game2.gamePhase != Game2.GamePhase.GameOverSplatter
      ...
      if (Game2.gamePhase == Game2.GamePhase.GameOverSplatter)
      {
        ...
        if ((double)this.screenManager.posBlackScreenOnBlood.X > 8000.0)
        {
            ...
            Game2.gamePhase = Game2.GamePhase.GameOverScreen;
        }
      }
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      if (Game2.gamePhase == Game2.GamePhase.GameOverScreen)
      {
      ...
      if (Game2.gamePhase == Game2.GamePhase.Game 
            && Player.location == Game2.Room.ParentsRoom)
       {
        this.spriteBatch.DrawString( this.spriteFont, 
        ...
        if (this.monster.location == Game2.Room.ParentsRoom)
          this.spriteBatch.DrawString(this.spriteFont,
